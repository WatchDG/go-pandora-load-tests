...
require (
	...
	github.com/yandex/pandora v0.5.0
)
...
require (
	...
	github.com/json-iterator/go v0.0.0-20180214060632-e7c7f3b33712 // indirect
	...
	gopkg.in/bluesuncorp/validator.v9 v9.10.0 // indirect
